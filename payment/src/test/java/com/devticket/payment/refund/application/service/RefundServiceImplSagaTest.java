...
class RefundServiceImplSagaTest {
    ...
    class SellerAdminCancel {
        ...
        void seller_소유권_일치() {
            ...
            verify(eventInternalClient).forceCancel(eventId, sellerId, "sold-out");
        }
        ...
        void seller_소유권_불일치_예외() {
            ...
            assertThatThrownBy(() -> service.cancelSellerEvent(sellerId, eventId, "reason"))
                .isInstanceOf(RefundException.class);
            verify(eventInternalClient, never()).forceCancel(any(), any(), any());
        }
        ...
        void admin_소유권검증_없이_통과() {
            ...
            verify(eventInternalClient).forceCancel(eventId, adminId, "policy-violation");
