...
| GET | `/api/orders` | `OrderController#getOrderList` | 본인 주문 목록 페이지 조회 |
...
| GET | `/internal/orders/{orderId}/tickets` | `InternalOrderController#getOrderTickets` | 환불 산정용 주문 티켓 목록 |
